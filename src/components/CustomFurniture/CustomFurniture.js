  ...
  return (
    <React.Fragment>
      <div className='site-section'>
        ...
        <p className='site-contents'>Heb je een vraag of een idee voor een maatwerk meubel, schroom dan niet om <a href="" onClick={() => openContact()}>contact</a> met mij op te nemen!</p>
      </div>
    </React.Fragment>
  )
}
