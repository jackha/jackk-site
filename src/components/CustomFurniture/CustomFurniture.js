  ...
  return (
    <React.Fragment>
      <div className='site-section'>
        ...
        <p className='site-contents'>Heb je een vraag of een idee voor een maatwerk meubel, schroom dan niet om <ContactButton text="contact" class="navigate-inline" /> met mij op te nemen! Wil je meer lezen over meubels op maat? Dat kan <NavigateButton text="hier" class="navigate-inline" link="/custom-furniture"/>.</p>
      </div>
    </React.Fragment>
  )
}
